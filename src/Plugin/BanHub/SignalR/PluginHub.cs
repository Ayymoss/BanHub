...
namespace BanHub.Plugin.SignalR;
...
public class PluginHub : IAsyncDisposable
{
    ...
    public async Task HeartbeatAsync(CommunityHeartbeatCommandSlim communityHeartbeat)
    {
    ...
    public async Task HeartbeatAsync(PlayersHeartbeatCommandSlim playersHeartbeat)
    {
        if (_hubConnection is null) return;
    ...
    public async Task HeartbeatAsync(PlayerJoined player)
    {
        if (_hubConnection is null) return;
