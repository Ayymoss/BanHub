...
public class PenaltyController(ISender sender, ISignedInUsersManager signedInUsersManager) : ControllerBase
{
    ...
    public async Task<ActionResult<IEnumerable<Application.DTOs.WebView.PlayerProfileView.Penalty>>> GetProfilePenaltiesPaginationAsync(
    ...
    [HttpGet("Latest")]
    public async Task<ActionResult<IEnumerable<Application.DTOs.WebView.IndexView.Penalty>>> GetLatestBansAsync()
    {
        var adminSignInGuid = User.Claims.FirstOrDefault(c => c.Type == "SignedInGuid")?.Value;
