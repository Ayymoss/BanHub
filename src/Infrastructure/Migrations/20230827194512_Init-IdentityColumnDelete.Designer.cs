...
namespace BanHub.Infrastructure.Migrations
{
    ...
    [Migration("20230827194512_Init-IdentityColumnDelete")]
    partial class InitIdentityColumnDelete
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BanHub.WebCore.Server.Domains.EFAlias", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            Created = new DateTimeOffset(new DateTime(2023, 8, 27, 19, 45, 11, 912, DateTimeKind.Unspecified).AddTicks(8973), new TimeSpan(0, 0, 0, 0, 0)),
                            IpAddress = "0.0.0.0",
                            PlayerId = -1,
                            UserName = "IW4MAdmin"
                        });
            ...
            modelBuilder.Entity("BanHub.WebCore.Server.Domains.EFChat", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PlayerId = -1,
                            ServerId = -1,
                            Submitted = new DateTimeOffset(new DateTime(2023, 8, 27, 19, 45, 11, 912, DateTimeKind.Unspecified).AddTicks(9217), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("BanHub.WebCore.Server.Domains.EFCommunity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            ApiKey = new Guid("06c7b389-ffe2-496f-b895-d0276698f5b4"),
                            CommunityGuid = new Guid("754e8caf-477c-49d5-be47-7662088eef0c"),
                            CommunityIp = "123.123.123.123",
                            CommunityIpFriendly = "zombo.com",
                            CommunityName = "Seed Instance",
                            CommunityPort = 1624,
                            Created = new DateTimeOffset(new DateTime(2023, 8, 27, 19, 45, 11, 912, DateTimeKind.Unspecified).AddTicks(9194), new TimeSpan(0, 0, 0, 0, 0)),
                            HeartBeat = new DateTimeOffset(new DateTime(2023, 8, 27, 19, 45, 11, 912, DateTimeKind.Unspecified).AddTicks(9193), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("BanHub.WebCore.Server.Domains.EFPenalty", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IssuerId = -1,
                            PenaltyGuid = new Guid("4d863dab-97bd-4850-8f05-63cdf0bb0e8a"),
                            PenaltyScope = 20,
                            PenaltyStatus = 10,
                            PenaltyType = 8,
                            Reason = "Seed Infraction",
                            RecipientId = -1,
                            Submitted = new DateTimeOffset(new DateTime(2023, 8, 27, 19, 45, 11, 912, DateTimeKind.Unspecified).AddTicks(9210), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("BanHub.WebCore.Server.Domains.EFPlayer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = -1,
                            CommunityRole = 10,
                            Created = new DateTimeOffset(new DateTime(2023, 8, 27, 19, 45, 11, 912, DateTimeKind.Unspecified).AddTicks(8978), new TimeSpan(0, 0, 0, 0, 0)),
                            Heartbeat = new DateTimeOffset(new DateTime(2023, 8, 27, 19, 45, 11, 912, DateTimeKind.Unspecified).AddTicks(8977), new TimeSpan(0, 0, 0, 0, 0)),
                            Identity = "0:UKN",
            ...
            modelBuilder.Entity("BanHub.WebCore.Server.Domains.EFServer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ServerName = "Shef",
                            ServerPort = 123,
                            Updated = new DateTimeOffset(new DateTime(2023, 8, 27, 19, 45, 11, 912, DateTimeKind.Unspecified).AddTicks(9224), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
