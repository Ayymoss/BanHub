...
namespace BanHub.Infrastructure.Migrations
{
    ...
    [Migration("20230826141512_Init-Sentiment")]
    partial class InitSentiment
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BanHub.WebCore.Server.Domains.EFAlias", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            Created = new DateTimeOffset(new DateTime(2023, 8, 26, 14, 15, 12, 606, DateTimeKind.Unspecified).AddTicks(905), new TimeSpan(0, 0, 0, 0, 0)),
                            IpAddress = "0.0.0.0",
                            PlayerId = -1,
                            UserName = "IW4MAdmin"
                        });
            ...
            modelBuilder.Entity("BanHub.WebCore.Server.Domains.EFChat", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PlayerId = -1,
                            ServerId = -1,
                            Submitted = new DateTimeOffset(new DateTime(2023, 8, 26, 14, 15, 12, 606, DateTimeKind.Unspecified).AddTicks(1141), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("BanHub.WebCore.Server.Domains.EFCommunity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            ApiKey = new Guid("51fa2c41-fdbe-46c0-a4b7-733b45b49f3d"),
                            CommunityGuid = new Guid("c522baa6-ffcb-4ac2-9ec5-a958d2016962"),
                            CommunityIp = "123.123.123.123",
                            CommunityIpFriendly = "zombo.com",
                            CommunityName = "Seed Instance",
                            CommunityPort = 1624,
                            Created = new DateTimeOffset(new DateTime(2023, 8, 26, 14, 15, 12, 606, DateTimeKind.Unspecified).AddTicks(1119), new TimeSpan(0, 0, 0, 0, 0)),
                            HeartBeat = new DateTimeOffset(new DateTime(2023, 8, 26, 14, 15, 12, 606, DateTimeKind.Unspecified).AddTicks(1117), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("BanHub.WebCore.Server.Domains.EFPenalty", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IssuerId = -1,
                            PenaltyGuid = new Guid("80148588-fafa-4389-9f1a-5f24ae349d4f"),
                            PenaltyScope = 20,
                            PenaltyStatus = 10,
                            PenaltyType = 8,
                            Reason = "Seed Infraction",
                            RecipientId = -1,
                            Submitted = new DateTimeOffset(new DateTime(2023, 8, 26, 14, 15, 12, 606, DateTimeKind.Unspecified).AddTicks(1134), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("BanHub.WebCore.Server.Domains.EFPlayer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = -1,
                            CommunityRole = 10,
                            Created = new DateTimeOffset(new DateTime(2023, 8, 26, 14, 15, 12, 606, DateTimeKind.Unspecified).AddTicks(911), new TimeSpan(0, 0, 0, 0, 0)),
                            Heartbeat = new DateTimeOffset(new DateTime(2023, 8, 26, 14, 15, 12, 606, DateTimeKind.Unspecified).AddTicks(911), new TimeSpan(0, 0, 0, 0, 0)),
                            Identity = "0:UKN",
            ...
            modelBuilder.Entity("BanHub.WebCore.Server.Domains.EFServer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ServerName = "Shef",
                            ServerPort = 123,
                            Updated = new DateTimeOffset(new DateTime(2023, 8, 26, 14, 15, 12, 606, DateTimeKind.Unspecified).AddTicks(1150), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
